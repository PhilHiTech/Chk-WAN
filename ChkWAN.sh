...
#           ChkWAN  rebootwan
#                   Will restart the WAN interface if the PINGs to ALL of the hosts FAIL, and if after 20 seconds the PINGs to ALL hosts FAIL again to the all WANs, will REBOOT router
#           ChkWAN  stop
